    ...
    <section className="contact-form">
      ...
      <div className="contact-application">
        <form action="" method="POST" onSubmit={handleSubmit}>
          ...
          <input id="phone" name="phone" type="text" onChange={handleChange} value={formData.phone} required />
          <label htmlFor="message">Comment or Message</label>
          <textarea id="message" name="message" onChange={handleChange} value={formData.msg} required />
                      <button type="submit" className="services-submit-btn" disabled={isLoading}>{isLoading ? <ClipLoader size={20} color="#333"/> :"Submit"}</button>
