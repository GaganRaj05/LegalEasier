  ...
  return (
    <section className="terms-info">
      <p className="effective-date">
        <strong>Effective Date:</strong> 5/15/2025
      </p>
      <p>
        These Terms and Conditions (“Terms”) govern your use of the services
        provided by <strong>LegalEasier</strong>
        (“we,” “us,” or “our”). By using our services or subscribing to our SMS
        marketing list, you agree to comply with and be bound by these Terms. If
        you do not agree to these Terms, you should not use our services or
      ...
      <p>
        ...
        Conditions. These Terms are a legal agreement between you and
        LegalEasier, and they apply to all users who access our website or
        receive services.
      </p>
      ...
      <ul>
        <li>Promotional offers, discounts, and updates on services</li>
        <li>
          Reminders and notifications related to your use of LegalEasier
          services.
        </li>
      ...
      <ul>
        <li>
          ...
          subscribing to our SMS list.
        </li>
        <li>
          <strong>Consent:</strong> Your explicit consent to receive SMS
          marketing messages by opting in. By subscribing to our SMS service,
          you give us permission to send marketing messages to the phone number
          provided.
        </li>
      </ul>
      ...
      <p>
        ...
        parties except with trusted service providers solely for the purpose of
      ...
      <p>
        ...
        opting out, you will no longer receive marketing messages, but you may
      ...
      <p>
        ...
        charges from your carrier based on your service plan. The frequency of
...
By subscribing to our SMS marketing, you agree to: 
      ...
      <p>
        ...
        LegalEasier website or interfere with any other party’s use of the
        services.
      </p>
